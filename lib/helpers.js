...
Client.prototype.branch = function (user, repo, from, to, callback) {
  var query = {owner: user, repo: repo, ref: 'heads/' + from}
  return this._when(this.get('/repos/:owner/:repo/git/refs/:ref', query), function (res) {
...
Client.prototype.merge = function (user, repo, branch, to, callback) {
  ...
  return this.post('/repos/:owner/:repo/merges', query)
}

Client.prototype.deleteBranch = function (user, repo, branch, callback) {
  return this.delete('/repos/:owner/:repo/git/refs/:ref', {
    owner: user,
    repo: repo,
    ref: 'heads/' + branch
  }, callback)
...
Client.prototype.pages = function (user, repo, callback) {
  return this.get('/repos/:owner/:repo/pages', {
    owner: user,
    repo: repo
  }, callback)
}

Client.prototype.pagesBuild = function (user, repo, callback) {
  return this.post('/repos/:owner/:repo/pages/builds', {
    owner: user,
    repo: repo
  }, callback)
}
